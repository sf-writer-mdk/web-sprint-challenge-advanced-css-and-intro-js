...
1. How would you describe acessibility on the web to someone new to programming?
   Acessibility is the ability of a website to adhere to people with certain disabilities

2. Talk about 3 different things you can do to ensure your website is accessible.
   1- adding descriptions for 'alt' on image tags
   2- ensuring there is an appropriate amount of contrast between certain colors
   3-

3. How would you explain the concept of a variable to someone new to programming?
   A variable is a container in memory that a primitive value or an object value resides in

4. What is the purpose of using functions in code?
   A function allows us to not have to repeat code. We give it input, and it does some work, and it gives us an output
